...
-   A lot of learning about the environmental system, art to deciding where the model is applicability of the model

-   often dealing with things over time (we went into environmental science because things are changing)

-   Interpreting complex equations and conducting uncertainty analysis
...
Most models have theory embedded in them, choice of what to put into the model is informed by what you think is important to the system. What do you need to know from the model?

The more you can hone in on this the clearer the model will be.
