...
You observe some sort of problem- ex: difference in bird calls, observationaly attributing something to a cause- this is probably how you fit your model but this could be wrong
...
**Input** : Change in unemployment rate (what is driving the system)

**Output** : Change in GDP

**Parameters** : Slope and intercept of the line (what is the shape of the outcome)
...
-   Are there inputs/parameters that you want to vary across scenarios (things you'd want to 'change')
